...
var url = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDiECp6jiWwUTSDP2M2d_Nwcfwwjgp6j6c&channelId=UC_sdtjo-z0hBcBp9kMbhHpg&part=snippet,id&order=date&maxResults=2";

var succes = function(data) {
    var element = document.getElementById("zone-video");
    var url_video = data.items[1].id.videoId;
